...
export default function LicenseForm({ initialPlan }: LicenseFormProps) {
  const [selectedPlan, setSelectedPlan] = useState(initialPlan || "mensuel");
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col h-full justify-between">
                      ...
                      <p className="mt-3 text-[11px] text-gray-500 leading-tight">{p.desc}</p>
                    </div>
                  </button>
                );
              })}
