...
import { Store, Building2, Hash, ShieldCheck } from "lucide-react";

type ShopFormProps = {
  licenseID: string;
};

export default function ShopForm({ licenseID }: ShopFormProps) {
  return (
        ...
        <form action="/api/createShop" method="POST" className="space-y-6">
          ...
          <div className="pt-6 space-y-4 border-t border-gray-100">
            ...
            <div className="flex items-center justify-center gap-2 text-gray-400">
              <ShieldCheck size={16} />
              <p className="text-xs">Informations sécurisées et modifiables ultérieurement</p>
            </div>
          </div>
        </form>
      </motion.div>
